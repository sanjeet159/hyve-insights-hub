import blog24jpg from "@/assets/blog-24.jpg";
...
const post: BlogPostWithContent = {
  ...
  content: `<div style="font-family:inherit;line-height:1.8;color:#333;max-width:100%">
    ...
    <h2 style="font-size:26px;font-weight:800;color:#0d0d0d;margin:40px 0 20px 0">How to Build a Portfolio that Gets High-Ticket Clients: The Strategic Overview</h2>
    ...
    <div style="background:#f1ab13;color:#fff;padding:28px;border-radius:16px;margin:40px 0">
      ...
      <p style="margin-bottom:0;opacity:0.95;font-size:16px;line-height:1.6">How to Build a Portfolio that Gets High-Ticket Clients is about building sustainable professional relationships through signal-based collaboration in a digital-first economy.</p>
    </div>
